...
class ApplicationTests {
	...
	public static Note note1 = new Note("12345", user1, emptyTagList, emptyFolderList,"MyNote", "https://clickup.com/blog/wp-content/uploads/2020/01/note-taking.png", "", true, new Date(), new Date());
	public static Note note2 = new Note("23456", user1, emptyTagList, emptyFolderList,"1181 Lecture", "http://lecture1181.pdf", "", false, new Date(), new Date());
	public static Note note3 = new Note("34567", user2,emptyTagList, emptyFolderList,"PHYS Lecture", "http://phys-test.pdf", "", true, new Date(), new Date());
